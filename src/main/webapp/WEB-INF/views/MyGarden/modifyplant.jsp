...
<title>DodamDodam Modify Plant</title>
<script src="resources/js/jquery.js"></script>
<script src="resources/js/bootstrap.min.js"></script>
<script src="resources/js/common.js"></script>
<script src="resources/js/modifyplants.js"></script>
...
<body>
		...
		<div class="regis_wrap">
			...
			<br> <br>
			<br>
			<form action="modifyplantProcess" method="post" id="modifyform">
				<input type="hidden" name="device_id" id="device_id" value="${device.device_id}">
				<input type="hidden" name="current_shape" id="current_shape" value="${device.flower.f_shape}">
				<label>식물 종: </label><br> 
				<input type="text" id="f_name" name="f_name" list="plants" value="${device.flower.f_name }">
				<datalist id="plants">
				...
				<br> <br> 
				<label>화분 닉네임: </label><br> 
				<input type="text" id="f_nick" name="f_nick" placeholder="화분 이름을 입력해주세요!" value="${device.flower.f_nick}">
				<br> <br> 
				

				</select> <br> <br> <br> <label>화분 모양을 선택해 주세요!</label><br>
				<br>
				...
				<br> <label>심은 날짜: </label><br> <input type="date"
					id="f_date" name="f_date" value="${device.flower.f_date}"
