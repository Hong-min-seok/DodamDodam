...
<title>DodamDodam Input My Plants</title>
...
<link rel="stylesheet" type = "text/css" href="resources/css/joincompletepage.css">
...
<body>
   ...
   <div class="complete_container">
		<h1 style="margin-bottom: 2em;">식물 등록 완료!</h1>
		<img alt="flower" src="resources/img/flowerselect/${f_shape}.png">
		<h3 style="margin: 3em">${f_nick}(이)가 새로운 가족이 되었어요!</h3>
		<button class="btn1" onclick="location.href='mygarden'">나의 정원 가기</button>
	</div>
