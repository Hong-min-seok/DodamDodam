...
<head>
	...
	<title>DodamDodam Delete Plant</title>
	<link rel="stylesheet" href="resources/css/bootstrap.css">
	<script src="resources/js/jquery.js"></script>
	<script src="resources/js/bootstrap.min.js"></script>
	<script src="resources/js/common.js"></script>
	<link rel="stylesheet" type = "text/css" href="resources/css/common.css">
	<link rel="stylesheet" type = "text/css" href="resources/css/deleteplantpage.css">
...
<body>
	...
	<div class="container1">
		<img alt="${f_shape}" src="resources/img/flowerselect/${f_shape}.png">
		<div class="container2">
			<p><strong>정말 ${f_nick}를 삭제하실건가요?</strong></p>
			<p>그동안 키워주셔서 고마웠어요</p>
			<button class="btn1" onclick="location.href='deleteplantprocess?device_id=${device_id}'">삭제하기</button>
		</div>
	</div>
