...
<body>
	...
	<input type="hidden" id="device_id" name="device_id" value="DODAM02">
	
	시작날짜 : <input type="date" id="startdate" name="startdate"> ~ 종료날짜 : <input type="date" id="enddate" name="enddate">
	<button id="multiphotobtn">사진보기</button>
