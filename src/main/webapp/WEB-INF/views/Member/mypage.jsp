...
<head>
	...
	<title>DodamDodam My Page</title>
...
<body>
	...
	<div class="container1">
		<img src="resources/img/icon/flower_icon5.png">
		<div class="userinfo">
			아이디 : ${user.userid} <br>
			닉네임 : ${user.nick} <br>
			이메일 : ${user.email} <br>
	...
	<div class="container2">
		<button class="btn1" onclick="location.href='changeinfo'">정보수정</button>
		<button class="btn1" onclick="location.href='changepw'">비밀번호 변경</button>
	</div>
	
	<div class="container3">
		<a href="quitmember" style="margin-top:5em; margin-right:2em;">회원탈퇴</a>
	</div>
