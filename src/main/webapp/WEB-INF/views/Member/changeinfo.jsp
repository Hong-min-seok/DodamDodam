...
<head>
	...
	<title>DodamDodam Change Info</title>
	...
	<link rel="stylesheet" type = "text/css" href="resources/css/changeinfo.css">
...
<body>
	...
	<div class="container1">
		...
		<form action="changeinfoprocess" method="post" id="infochangeform">
			<label>닉네임</label>
			<input type="text" id="nick" name="nick" value="${user.nick}">
			<div class="valid" id="nickvalid"></div>
			
			<label>이메일</label>
			<input type="text" id="mail" name="mail" value="${user.email}">
			<div class="valid" id="mailvalid">※ 이메일로 인증 번호를 전송하니, 정확히 입력해주세요!</div>

		</form>
		
		<button class="btn1" id="frmbtn">회원정보 변경</button>
