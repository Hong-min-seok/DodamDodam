...
<body>
   ...
   <h4 class="subtitle">회원가입시 등록한 이메일로 아이디를 전송해드립니다.</h4>
   
   <div class="container1">
   
      <form name="emailCheck" action="./findId" method="post" id="findidform" onsubmit="return checkForm();">
      

         <input type="text" id="mail" name="email" placeholder="이메일을 입력하세요">
         <div class="valid" id="mailvalid"></div>
      <input type="submit"  class="btn1" id="frmbtn" value="아이디 찾기">
      </form>
