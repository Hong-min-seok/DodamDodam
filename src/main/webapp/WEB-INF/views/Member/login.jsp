...
<head>
   ...
   <title>DodamDodam Login Page</title>
...
<body>
   ...
   <img src="resources/img/floating/floating_flower.png" class="floating1">
   <img src="resources/img/floating/floating_leaf2.png" class="floating2">
   <img src="resources/img/floating/floating_flower.png" class="floating3">
   <img src="resources/img/floating/floating_leaf2.png" class="floating4">
   <img src="resources/img/floating/floating_flower.png" class="floating5">
   <img src="resources/img/floating/floating_leaf2.png" class="floating6">
   <img src="resources/img/floating/floating_flower.png" class="floating7">
   <img src="resources/img/floating/floating_leaf2.png" class="floating8">
   
   <div class="login_form_container">
   <img src="resources/img/logo/logo.png">
   
   <form action="loginprocess" method="post" class="login_form" id="login_form">
      <input type="text" id="input_id" name="input_id" placeholder="아이디">
      <div class="idvalidate validate"></div>
      <input type="password" id="input_pw" name="input_pw" placeholder="비밀번호">
      <div class="pwvalidate validate"></div>
      <div class="loginvalidate"></div>
      <input type="hidden" id="input_referrer" name="input_referrer">
   </form>
   <button id="loginbtn" class="btn1" style="font-family: S-CoreDream-9Black" >로그인</button>
