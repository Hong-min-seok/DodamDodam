...
<head>
	...
	<title>DodamDodam Quit Member</title>
	<link rel="stylesheet" href="resources/css/bootstrap.css">
	<script src="resources/js/jquery.js"></script>
	<script src="resources/js/bootstrap.min.js"></script>
	<script src="resources/js/common.js"></script>
	<link rel="stylesheet" type = "text/css" href="resources/css/common.css">
	<link rel="stylesheet" type = "text/css" href="resources/css/quitmember.css">
...
<body>
	...
	<div class="container1">
		<img alt="cryingflower" src="resources/img/icon/cryingflower2.png">
		<div class="container2">
			<p><strong>정말 도담도담을 떠나실건가요?</strong></p>
			<p>한번 탈퇴하면 정보를 복구하기 어려워요!</p>
			<p style="font-size: 14pt"><br><br>비밀번호를 입력하면 탈퇴됩니다.</p>
			<div class="container3">
				<form action="quitprocess">
				<input type="password" id="input_pw" name="input_pw">
				<input type="submit" class="btn1" onclick="submit" value="탈퇴하기">
				</form>
			</div>
		</div>
	</div>
