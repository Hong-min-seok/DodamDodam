...
<head>
	...
	<title>DodamDodam Join Complete</title>
...
<body>
	...
	<div class="complete_container">
		<h1 style="margin-bottom: 2em;">회원가입 완료!</h1>
		<img alt="flower_icon3" src="resources/img/icon/flower_icon3.png">
		<h3>도담도담의 새로운 가족이 되신것을 환영합니다.</h3>
		<button class="btn1" onclick="location.href='login'">로그인하러 가기</button>
	</div>
